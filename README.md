📊 Subscription Data Analysis using Pandas
📌 Overview

This project performs exploratory data analysis and feature engineering on a subscription dataset using Python and Pandas in Jupyter Notebook.

The objective is to understand user behavior and identify factors that influence subscription purchases.

The dataset contains 9,999 user records with demographic and behavioral attributes.
